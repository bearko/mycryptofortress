...
export const SKILLS: SkillDef[] = [
  ...
  // ─── SPEC-019: Rare 8 体のスキル ────────────────────────
  {
    heroId: 3001,
    name: "日本一の兵",
    description: "六文銭の覚悟。与ダメージが 2.5 倍に。",
    seCategory: "buff",
    effectType: "damageMultiplier",
    value: 2.5,
    durationSec: 8,
  ...
  },
  {
    heroId: 3002,
    name: "影分身",
    description: "進行が最も先の敵 1 体に 5.0 倍の必殺の刺突。",
    seCategory: "single_damage",
    effectType: "singleStrike",
    value: 5.0,
    durationSec: 0,
  ...
  },
  {
    heroId: 3003,
    name: "風林火山",
    description: "範囲内の味方の攻撃間隔を 1/1.8 に短縮。",
    seCategory: "buff",
    effectType: "agiBuff",
    value: 1.8,
    durationSec: 10,
  ...
  },
  {
    heroId: 3004,
    name: "毘沙門天の旗",
    description: "戦神の加護。与ダメージが 2.3 倍に。",
    seCategory: "buff",
    effectType: "damageMultiplier",
    value: 2.3,
    durationSec: 8,
  ...
  },
  {
    heroId: 3005,
    name: "義をもって",
    description: "範囲内の敵の防御を 0.35 倍に削る。",
    seCategory: "debuff_status_effect",
    effectType: "enemyDefDebuff",
    value: 0.35,
    durationSec: 10,
  ...
  },
  {
    heroId: 3006,
    name: "我が辞書に不可能なし",
    description: "戦術の天才。与ダメージが 2.0 倍に。",
    seCategory: "area_damage",
    effectType: "damageMultiplier",
    value: 2.0,
    durationSec: 12,
  ...
  },
  {
    heroId: 3007,
    name: "シャーウッドの矢",
    description: "進行が最も先の敵 1 体に 4.5 倍の必殺射撃。",
    seCategory: "single_damage",
    effectType: "singleStrike",
    value: 4.5,
    durationSec: 0,
  ...
  // ─── SPEC-019: SuperRare 8 体のスキル ───────────────────
  {
    heroId: 4001,
    name: "天下布武",
    description: "覇王の威光。与ダメージが 3.0 倍に。",
    seCategory: "area_damage",
    effectType: "damageMultiplier",
    value: 3.0,
    durationSec: 10,
  ...
  },
  {
    heroId: 4002,
    name: "墨俣一夜城",
    description: "閃きの戦術で攻撃間隔を 1/2.0 に短縮。",
    seCategory: "buff",
    effectType: "agiBuff",
    value: 2.0,
    durationSec: 10,
  ...
  },
  {
    heroId: 4003,
    name: "鳴くまで待とう",
    description: "忍耐の力。与ダメージが 2.6 倍に。",
    seCategory: "buff",
    effectType: "damageMultiplier",
    value: 2.6,
    durationSec: 12,
  ...
  },
  {
    heroId: 4004,
    name: "八陣の計",
    description: "範囲内の敵の防御を 0.25 倍に削る。",
    seCategory: "debuff_status_effect",
    effectType: "enemyDefDebuff",
    value: 0.25,
    durationSec: 12,
  ...
  },
  {
    heroId: 4005,
    name: "オルレアンの乙女",
    description: "聖なる剣。与ダメージが 2.8 倍に。",
    seCategory: "buff",
    effectType: "damageMultiplier",
    value: 2.8,
    durationSec: 10,
  ...
  },
  {
    heroId: 4006,
    name: "エクスカリバー",
    description: "選定の剣。与ダメージが 3.2 倍に。",
    seCategory: "buff",
    effectType: "damageMultiplier",
    value: 3.2,
    durationSec: 8,
  ...
  },
  {
    heroId: 4007,
    name: "ナイルの女王",
    description: "範囲内の敵の防御を 0.3 倍に削る。",
    seCategory: "debuff_status_effect",
    effectType: "enemyDefDebuff",
    value: 0.3,
    durationSec: 12,
  ...
  },
  {
    heroId: 4008,
    name: "ヒポクラテスの誓い",
    description: "範囲内の味方を INT 回復公式で 3.0 倍係数で回復する。",
    seCategory: "heal_resurrection",
    effectType: "heal",
    value: 3.0,
    durationSec: 0,
  ...
  // ─── SPEC-019: Legendary 4 体のスキル ───────────────────
  {
    heroId: 5001,
    name: "邪馬台の神託",
    description: "範囲内の味方を INT 回復公式で 4.0 倍係数で回復する。",
    seCategory: "heal_resurrection",
    effectType: "heal",
    value: 4.0,
    durationSec: 0,
  ...
  },
  {
    heroId: 5002,
    name: "東征の神威",
    description: "建国の力。与ダメージが 3.5 倍に。",
    seCategory: "buff",
    effectType: "damageMultiplier",
    value: 3.5,
    durationSec: 12,
  ...
  },
  {
    heroId: 5003,
    name: "それでも地球は回る",
    description: "進行が最も先の敵 1 体に 7.0 倍の必殺の天体落下。",
    seCategory: "single_damage",
    effectType: "singleStrike",
    value: 7.0,
    durationSec: 0,
  ...
  },
  {
    heroId: 5004,
    name: "12 の功業",
    description: "神話の力。与ダメージが 4.0 倍に。",
    seCategory: "buff",
    effectType: "damageMultiplier",
    value: 4.0,
    durationSec: 8,
